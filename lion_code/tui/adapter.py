...
from lion_code.core.messages import AssistantMessage, CustomMessage, ToolCall, UserMessage
from lion_code.core.provider_events import TextDeltaEvent, ThinkingDeltaEvent
from lion_code.application.events import AutoRetryStartEvent, LionSessionEvent, QueueUpdateEvent
...
class TuiEventAdapter:
    ...
    def apply(self, event: LionSessionEvent) -> None:
